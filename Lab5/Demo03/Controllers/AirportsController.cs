...
namespace Demo03.Controllers
{
    public class AirportsController : Controller
    {
        ...
        public AirportsController(Demo03Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AirportId,Code,Name,City,Country")] Airport airport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AirportId,Code,Name,City,Country")] Airport airport)
        {
