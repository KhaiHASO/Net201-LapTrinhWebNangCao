...
public class FileController : Controller
{
    ...
    {
        return Content("Đây là ví dụ về ContentResult. Trả về văn bản thuần túy.", "text/plain");
    }
    ...
    public IActionResult DemoFileStream()
    {
        ...
        var content = "Nội dung file được tạo từ MemoryStream.";
        var stream = new MemoryStream(System.Text.Encoding.UTF8.GetBytes(content));
        return File(stream, "text/plain", "demo_stream.txt");
    }
